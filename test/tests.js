...
describe('User Module', function () {
  ...
  it('should be able to sign in users', function () {
    assert.equal(false, true);
  });

  it('should be able to add VIPs', function () {
    assert.equal(false, true);
  });

  it('should be able to check VIP List', function () {
    assert.equal(false, true);
  });
});

describe('Email Module', function () {
  it('should be able to receive emails', function () {
    assert.equal(false, true);
  });

  it('should be able to send emails', function () {
    assert.equal(false, true);
  });
  ...
  it('should be able to retrieve emails from escrow', function () {
    assert.equal(false, true);
  });
